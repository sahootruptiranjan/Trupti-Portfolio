                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {zomatoProject.processSteps?.map((step, idx) => (
                      <div
                        ...
                        className={`p-3.5 rounded-xl border transition-all cursor-pointer ${activeStep === idx
                ...
                <div className="pt-4 flex flex-wrap items-center gap-4">
                  ...
                  {zomatoProject.liveUrl && zomatoProject.liveUrl !== "#" ? (
                    ...
                    >
                      ...
                      <span>{zomatoProject.liveStatusText || "Executive Report"}</span>
                      <ArrowUpRight className="w-3.5 h-3.5 opacity-60" />
                    </a>
                  ) : (
                    <button
                      disabled
                      className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-700 text-slate-500 cursor-not-allowed text-xs font-mono font-medium"
                      title="Live Tableau/Power BI dashboard deployment link coming soon"
                    >
                      <ExternalLink className="w-4 h-4" />
                      <span>{zomatoProject.liveStatusText || "Live Dashboard (Coming Soon)"}</span>
                    </button>
                  )}
                  ...
                  <div className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-950 text-white shadow-xl relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-slate-800 text-xs font-mono text-slate-400">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="ml-2 text-slate-300">intern_performance_bi.view</span>
                      </div>
                      <span className="text-[11px] text-accent-cyan font-mono">POWER BI/ MYSQL</span>
                    </div>

                    {/* Abstract Chart 1: Rating Distribution Bars */}
                    <div className="mt-5 space-y-3">
                      <div className="flex items-center justify-between text-xs font-mono text-slate-400">
                        <span>Cohort Performance vs Target Benchmark</span>
                        <span className="text-accent-cyan font-semibold">DAX Scoring</span>
                      </div>
                      ...
                      <div className="space-y-2 pt-1">
                        <div>
                          <div className="flex justify-between text-[11px] font-mono text-slate-300 mb-1">
                            ...
                            <span className="text-accent-cyan">94.2% On-Time</span>
                          </div>
